...
public class BankAccount
{
    ...
    public bool ChangePin(string currentPin, string newPin)
    {
        ...
        // Check whether new PIN contains only numbers
...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Uncommenting below will cause compiler errors
        ...
        decimal currentBalance =
            account.GetBalance("1234");    // Correct PIN
